...
public class BaseAdapter<Model> extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements
        IBaseAdapter {
    ...
    public BaseAdapter<Model> setOnLongClickListener(OnLongClickListener<Model>
                                                             onLongClickListener) {
